...
public class MainGui extends javax.swing.JFrame {
    ...
    private Mode currentMode = Mode.JAVA;
    ...
    private void initComponents() {
        ...
        try {
			MenuIconLabel.setIcon(new javax.swing.ImageIcon(Paths.get("./res/icons/icons8-menü-30.png").toUri().toURL()));
        ...
        try {
			settingsIconLabel.setIcon(new javax.swing.ImageIcon(Paths.get("./res/icons/icons8-einstellungen-30.png").toUri().toURL()));
        ...
        try {
			saveLogIconLabel.setIcon(new javax.swing.ImageIcon(Paths.get("./res/icons/icons8-speichern-&-schließen-30.png").toUri().toURL()));
		} catch (MalformedURLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} // NOI18N
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(submissionsFileField, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(submissionsFileChooserButton))
                                            .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(outputDirectoryField, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(fileListFileField, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(fileListFileChooserButton))
                                            .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(solutionFileField, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(solutionFileFieldChooserButton))))
                                    .addComponent(executeButton, javax.swing.GroupLayout.PREFERRED_SIZE, 634, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addContainerGap())
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGap(0, 224, Short.MAX_VALUE)
                        .addComponent(JavaModeRadioButton)
                        .addGap(31, 31, 31)
                        .addComponent(RacketModeRadioButton)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(solutionFileField, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(solutionFileFieldChooserButton))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void updateExecuteButtonState() {
        switch (currentMode) {
            case JAVA:
                executeButton.setEnabled(!"".equals(submissionsFileField.getText()) && !"".equals(outputDirectoryField.getText()) && !"".equals(solutionFileField.getText()) && !"".equals(fileListFileField.getText()));
                break;
            case RACKET:
                executeButton.setEnabled(!"".equals(submissionsFileField.getText()) && !"".equals(outputDirectoryField.getText()) && !"".equals(solutionFileField.getText()));
                break;
        }
    ...
    private void openSettings() {
        JOptionPane.showMessageDialog(this, "Es gibt noch keine Settings!", "Information", JOptionPane.INFORMATION_MESSAGE);
    }
...
//                	extractor.extract();
                ...
                break;
            case RACKET:
                JOptionPane.showMessageDialog(this, "Der Racket-Modus ist geplant, aber noch nicht umgesetzt!", "Information", JOptionPane.INFORMATION_MESSAGE);
                break;
        }
    }
