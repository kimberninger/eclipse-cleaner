...
import project_cleaner.*;
import static project_cleaner.LanguageMode.*;
...
public class MainGui extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		try {
			MenuIconLabel
					.setIcon(new javax.swing.ImageIcon(Paths.get("./res/icons/icons8-menü-30.png").toUri().toURL()));
		...
		try {
			settingsIconLabel.setIcon(
					new javax.swing.ImageIcon(Paths.get("./res/icons/icons8-einstellungen-30.png").toUri().toURL()));
		...
		try {
			saveLogIconLabel.setIcon(new javax.swing.ImageIcon(
					Paths.get("./res/icons/icons8-speichern-&-schließen-30.png").toUri().toURL()));
		} catch (MalformedURLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} // NOI18N
